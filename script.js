// Malla curricular completa con créditos visibles y requisitos funcionales
const ramos = [
  // ----- Semestre 1 -----
  ...
  { id: 'geopoliticas', nombre: 'Seminario: Geopolíticas', semestre: 8, creditos: 2 },

  // ----- Semestre 9 -----
  { id: 'catedra', nombre: 'Cátedra de formación ciudadana y constitucional', semestre: 9, creditos: 2 },
  { id: 'practica9', nombre: 'Práctica Pedagógica IX', semestre: 9, creditos: 8, requisitos: ['practica8'] },

  // ----- Semestre 10 -----
  { id: 'trabajo_grado', nombre: 'Práctica Pedagógica X: Trabajo de grado', semestre: 10, creditos: 8, requisitos: ['practica9'] },
  { id: 'seminario_social', nombre: 'Seminario Interdisciplinario: Problemáticas Sociales', semestre: 10, creditos: 2 },
];
